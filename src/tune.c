...
int Shield[4][6] = {
    {21*1.75, 19*1.75, 8*1.75, 12*1.5, 17*1.5, 11*1.5},
    {31*1.75, 23*1.75, 5*1.75, 7*1.5, 5*1.5, 3*1.5},
    {25*1.75, 17*1.75, 12*1.75, 14*1.5, 17*1.5, 13*1.5},
    {25*1.75, 18*1.75, 16*1.75, 10*1.5, 7*1.5, 6*1.5}
};
