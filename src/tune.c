...
int Shield[4][6] = {
    {21*1.5, 19*1.5, 8*1.5, 12*1.25, 17*1.25, 11*1.25},
    {31*1.5, 23*1.5, 5*1.5, 7*1.25, 5*1.25, 3*1.25},
    {25*1.5, 17*1.5, 12*1.5, 14*1.25, 17*1.25, 13*1.25},
    {25*1.5, 18*1.5, 16*1.5, 10*1.25, 7*1.25, 6*1.25}
};
